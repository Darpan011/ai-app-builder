...
import { BlueTitle, GrayTitle, SectionHeading, SectionLabel } from "@/components/resuables";
...
export default function Home() {
  ...
  // Auto-resize textarea height based on content, with a max height of 200px
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] selection:big-white/20">
      <section className="relative flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        ...
        <p className="mt-10 text-xs text-white/20">
          Np credit card required. 10 free generations on sign up.
        </p>
      ...
      <section className="relative mx-auto mb-32 max-w-5xl overflow-hidden rounded-2xl border-white/8 px-10 py-24 text-center">
          <HoleBackground
          strokeColor="rgba(255,255,255,0.05)"
          className="absolute inset-0 h-full w-full"
          style={{
